...
Namespace Migrations
    ...
    Friend NotInheritable Class Configuration
        ...
        Protected Overrides Sub Seed(context As SchoolContext)
            ...
            Dim instructors As New List(Of Instructor) From {
            ...
            Dim courses = New List(Of Course) From {
                New Course With {
                    ...
                    .Title = "Chemistry",
                    .Credits = 3,
                    .DepartmentID = departments.Single(Function(s) (s.Name = "Engineering")).DepartmentID,
                    .Instructors = New List(Of Instructor)},
                New Course With {
                    .CourseID = 4022,
                    .Title = "Microeconomics",
                    .Credits = 3,
                    .DepartmentID = departments.Single(Function(s) (s.Name = "Economics")).DepartmentID,
                    .Instructors = New List(Of Instructor)},
                New Course With {
                    .CourseID = 4041,
                ...
                New Course With {
                    ...
                    .Title = "Calculus",
                    .Credits = 4,
                    .DepartmentID = departments.Single(Function(s) (s.Name = "Mathematics")).DepartmentID,
                    .Instructors = New List(Of Instructor)},
                New Course With {
                    .CourseID = 3141,
                    .Title = "Trigonometry",
                ...
                New Course With {
                    ...
                    .Title = "Composition",
                    .Credits = 3,
                    .DepartmentID = departments.Single(Function(s) (s.Name = "English")).DepartmentID,
                    .Instructors = New List(Of Instructor)},
                New Course With {
                    .CourseID = 2042,
                    .Title = "Literature",
            ...
            courses.ForEach(Sub(s) context.Courses.AddOrUpdate(Function(p) p.CourseID, s))
            context.SaveChanges()
        ...
        Private Sub AddOrUpdateInstructor(context As SchoolContext, courseTitle As String, instructorName As String)
